...
void MyMain::SetupBackgroundBuffer()
{
	// NEW SWITCH
	switch( m_state )
	{
...
int MyMain::InitialiseObjects()
{
	...
	m_ppDisplayableObjects[0] = new MyBall(this,1,1);
	m_ppDisplayableObjects[1] = new MyBall(this,9,9);
	m_ppDisplayableObjects[2] = new MyBall(this,13,9);
	m_ppDisplayableObjects[3] = new MyBall(this,9,5);
	m_ppDisplayableObjects[4] = new MyBall(this,13,5);
...
void MyMain::MouseDown( int iButton, int iX, int iY )
{
}
...
*/
void MyMain::KeyDown(int iKeyCode)
{
	// NEW SWITCH
	switch ( iKeyCode )
	{
